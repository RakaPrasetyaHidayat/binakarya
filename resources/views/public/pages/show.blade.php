...
@section('content')
<div class="bg-gray-50 dark:bg-slate-900 min-h-screen pt-16 sm:pt-20 md:pt-24 lg:pt-28 py-10 sm:py-16 lg:py-20 transition-colors duration-300 -mt-1">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article class="bg-white dark:bg-slate-800 shadow-xl shadow-gray-200/50 dark:shadow-black/20 rounded-3xl overflow-hidden border border-gray-100 dark:border-slate-700 transition-all duration-300">
            ...
            <div class="bg-gray-50/50 dark:bg-slate-900/30 px-6 py-6 sm:px-12 border-t border-gray-50 dark:border-slate-700/50 flex flex-col sm:flex-row justify-between items-center gap-4">
